        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this2.storageChar.set(STORAGE_KEY_CHAR, result);
            } else {
              return _this2.storageChar.set(STORAGE_KEY_CHAR, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storageChar.set(STORAGE_KEY_CHAR, result);
            }
          });
        }
      }]);
